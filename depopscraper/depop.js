...
(async () => {
  ...
  try {
    ...
    console.log('Navigating to depop product page...');
    
    await page.goto('https://www.depop.com/products/prettypicksco-brand-new-authentic-miss-me/?moduleOrigin=likes', {
    ...
    await page.screenshot({ path: 'depop-page.png' });
    ...
    let productData = {
      url: 'https://www.depop.com/products/prettypicksco-brand-new-authentic-miss-me/?moduleOrigin=likes',
    ...
    fs.writeFileSync('depop-product.json', JSON.stringify(productData, null, 2));
    console.log('Product data saved to depop-product.json');
